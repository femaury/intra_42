//
//  OldClustersViewController.swift
//  Intra 42
//
...
class OldClustersViewController: UIViewController, ClustersViewDelegate {
    ...
    lazy var clustersView = ClustersViewParis(frame: CGRect(x: 0, y: 0, width: 985, height: 755))
...
extension OldClustersViewController: UserProfileDataSource, SearchResultsDataSource {
...
extension OldClustersViewController: TablePickerDelegate {
...
extension OldClustersViewController: UIScrollViewDelegate {
...
//extension OldClustersViewController: UISearchBarDelegate {
//
